...
public interface VerificationRepository extends PagingAndSortingRepository<Verification, String> {
    ...
    List<Verification> findByProviderAndRejectedCalibratorDateBetweenAndStatusIn(Organization organization, Date dateFrom, Date DateTo, List<Status> statuses);
    ...
    List<Verification> findByStateVerificatorAndSignProtocolDateBetween(Organization organization, Date dateFrom, Date DateTo);
