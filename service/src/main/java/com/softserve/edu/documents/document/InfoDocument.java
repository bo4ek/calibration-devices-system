...
//                    break;
    ...
    public String getOwnerPhone() {
        String phone = getVerification().getClientData().getPhone();
        if (phone != null) {
            return phone;
        } else {
            return "не вказано";
    ...
    public String getOwnerMail() {
        String mail = getVerification().getClientData().getEmail();
        if (mail != null) {
            return mail;
        } else {
            return "не вказано";
    ...
    public String getProviderAddress() {
        ...
        return "обл." + address.getRegion() + "; район " + address.getDistrict() + "; місто " + address.getLocality() + "; вулиця " + address.getStreet() + "; будинок " + address.getBuilding() + "; квартира " + address.getFlat();
    }
