...
angular
    ...
    .factory('InitializeLibForDigitalSign', function () {
        ...
        var URL_XML_HTTP_PROXY_SERVICE = "http://java.training.local//Data/java/ProxyHandler.php";
        var CAsServers = null;
        var CAServer = {
            "issuerCNs": null,
            "address": null,
        ...
        var URL_GET_CERTIFICATES = "http://java.training.local/Data/CACertificates.p7b?version=1.0.4";
        var URL_CAS = "http://java.training.local/Data/CAs.json?version=1.0.4";
